...
#   2) 지울 목록을 한 번 보여 주고 묻지 않고 지운다 (설치 도우미가 놓은 것만 · cys 프로그램은 남긴다 — 윈도우와 같다)
...
#   (installer-speed-pin-0320) 1.0.1 부터 프로그램 이름은 cysr.app 이다 — 지우개가 cysr.app·옛 이름 cys.app 을 둘 다 알아보고 남긴다.
...
# ── 2단 · 지운다 ──────────────────────────────────────────────────
# 목록을 보여 주는 일은 지우는 도구가 한다. 여기서도 거기서도 묻지 않는다.
